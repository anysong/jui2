;(function($,win,doc,unde){
	$.fn.pageFun = function(options){
		...
		var Method = {
			...
			getData : function(){
				if (opts.jsn.pageNum > 0 && opts.btn) {
					opts.btn = false
					opts.pNum = opts.jsn.pageNum
					opts.cacheNum = opts.jsn.pageNum
				} else {
					opts.jsn.pageNum = opts.cacheNum;
				}
				opts.jsn.pageSize = opts.jsn.pageSize ? opts.jsn.pageSize : opts.pageSize;
				$.ajax({
					"type" : "get",
					"url" : opts.interFace,
					"data" : opts.jsn,
